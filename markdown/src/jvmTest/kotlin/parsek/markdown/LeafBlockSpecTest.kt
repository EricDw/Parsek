...
/**
 * Runs CommonMark spec examples for leaf block sections against the markdown parser.
 *
...
class LeafBlockSpecTest {
    ...
    fun leafBlockCompliance() {
        ...
        // Print results
        println("\n=== markdown Leaf Block Spec Compliance ===\n")
        var totalPass = 0
        var totalFail = 0
        var totalError = 0
    ...
    fun leafBlockDiff() {
        ...
        if (failures.isNotEmpty()) {
            println("\n=== markdown Leaf Block Failures (${failures.size}) ===\n")
