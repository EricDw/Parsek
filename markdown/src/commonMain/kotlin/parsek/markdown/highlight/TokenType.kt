...
sealed interface TokenType {
    ...
    data object TableDelimiter : TokenType

    /** Content of a header cell in a GFM table. */
    data object TableHeaderCell : TokenType
    ...
    data object StrikethroughMarker : TokenType
    ...
    // -------------------------------------------------------------------------
    // GFM extension — extended autolinks
    // -------------------------------------------------------------------------

    /** A bare URL or email address (extended autolink, no angle brackets). */
    data object ExtendedAutolinkUrl : TokenType
}
